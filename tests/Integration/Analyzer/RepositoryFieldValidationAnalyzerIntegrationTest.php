...
/**
 * Integration test for RepositoryFieldValidationAnalyzer.
 *
 * Tests the analyzer's ability to detect issues and provide actionable suggestions.
 */
final class RepositoryFieldValidationAnalyzerIntegrationTest extends TestCase
{
    ...
    {
        $repositoryFieldValidationAnalyzer = $this->createAnalyzer();
        $issueCollection = $repositoryFieldValidationAnalyzer->analyze(QueryDataCollection::empty());
    ...
    public function it_returns_consistent_results(): void
    {
        ...
        // Run analysis twice
        $issueCollection = $repositoryFieldValidationAnalyzer->analyze(QueryDataCollection::empty());
        $issues2 = $repositoryFieldValidationAnalyzer->analyze(QueryDataCollection::empty());
    ...
    private function createAnalyzer(): RepositoryFieldValidationAnalyzer
    {
        $entityManager = $this->entityManager;
        $issueFactory = new IssueFactory();

        return new RepositoryFieldValidationAnalyzer($entityManager, $issueFactory);
    }
}
